  ...
  return (
    <div className="font-[family-name:var(--font-geist-sans)] relative">
      ...
      <div className="w-full h-[900px] bg-[#FFFFFF] pt-30 px-6 text-center">
        <h1 className="text-3xl font-bold text-[#BF1414]">Resources Page</h1>
        <p className="mt-4 text-lg text-gray-700">Welcome to the Resources section of HotSpot.tech!</p>
      </div>
    </div>
  );
}
